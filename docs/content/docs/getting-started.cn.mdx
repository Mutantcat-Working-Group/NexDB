...
<Tabs groupId="platform" items={['macOS', 'Windows', 'Linux', 'Docker']}>
  ...
  <Tab value="Linux">
    使用 Flatpak 从 [FlatPark](https://flatpark.org/apps/org.mutantcat.nexdb/) 安装（适用于任意发行版）：
...
<Callout type="info">
  第一次参与开发请阅读 [NexDB 仓库](https://github.com/Mutantcat-Working-Group/NexDB)中的贡献指南。教程包含各系统环境安装、Fork、Issue 认领、测试和提交 PR 的完整步骤。
</Callout>
