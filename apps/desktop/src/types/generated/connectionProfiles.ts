...
export const CONNECTION_PROFILES = {
  ...
  minio: { type: "object-storage", port: 9000, user: "", label: "MinIO", icon: "minio" },
  rustfs: { type: "object-storage", port: 8000, user: "", label: "RustFS", icon: "rustfs" },
  s3: { type: "object-storage", port: 9000, user: "", label: "S3 兼容", icon: "s3" },
...
export const CONNECTION_PICKER_OPTIONS = [
  ...
  { value: "minio", label: "MinIO", category: "object_storage" },
  { value: "rustfs", label: "RustFS", category: "object_storage" },
  { value: "s3", label: "S3 兼容", category: "object_storage" },
